...
export const ELEMENT_DATA: PeriodicElement[] = [
  ...
  { position: 39, name: 'Yttrium', weight: 88.9058, symbol: 'Y' },
  ...
  { position: 45, name: 'Rhodium', weight: 102.906, symbol: 'Rh' },
  ...
  { position: 59, name: 'Praseodymium', weight: 140.908, symbol: 'Pr' },
  ...
  { position: 70, name: 'Ytterbium', weight: 173.045, symbol: 'Yb' },
  { position: 71, name: 'Lutetium', weight: 174.967, symbol: 'Lu' },
  { position: 72, name: 'Hafnium', weight: 178.49, symbol: 'Hf' },
  { position: 73, name: 'Tantalum', weight: 180.948, symbol: 'Ta' },
  ...
  { position: 79, name: 'Gold', weight: 196.967, symbol: 'Au' },
  { position: 80, name: 'Mercury', weight: 200.592, symbol: 'Hg' },
  { position: 81, name: 'Thallium', weight: 204.383, symbol: 'Tl' },
  ...
  { position: 91, name: 'Protactinium', weight: 231.036, symbol: 'Pa' },
  { position: 92, name: 'Uranium', weight: 238.029, symbol: 'U' },
